...
class TestSelfRecalibrationProjectorTimeFrequnecyLikelihood(unittest.TestCase):
    ...
    def test_log_likelihood_distribution_from_noise(self):
        ...
        import cProfile
        cProfile.run('likelihood.log_likelihood()')
    ...
    # def test_log_likelihood_with_cubic_spline_model(self):
    #     import time
...
if __name__ == '__main__':
    unittest.main()
    # import cProfile
    # obj = TestSelfRecalibrationProjectorTimeFrequnecyLikelihood()
    # obj.test_log_likelihood_with_cubic_spline_model()
    # cProfile.run('obj.test_log_likelihood_with_cubic_spline_model()', filename='output.prof')
...
extensions  = [
    Extension("nullcal.time_frequency_transform.inverse_wavelet_freq_funcs",
              ["nullcal/time_frequency_transform/inverse_wavelet_freq_funcs.pyx"],
...
setup(
    name="nullcal",
    description="Null stream self calibration",

...
TriangularInterferometer.__init__ = __init__
TriangularInterferometer.optimal_null_stream_snr_squared = \
    optimal_null_stream_snr_squared
TriangularInterferometer._network_meta_data = {}
TriangularInterferometer.meta_data = meta_data

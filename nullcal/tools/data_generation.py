...
class DataGenerationInput(BilbyDataGenerationInput, Input):
    ...
    def __init__(self, args, unknown_args, create_data=True):
        ...
        self.time_frequency_clustering_method = \
            args.time_frequency_clustering_method
        ...
        self.time_frequency_clustering_pe_samples_filename = \
            args.time_frequency_clustering_pe_samples_filename
        self.time_frequency_clustering_threshold = \
            args.time_frequency_clustering_threshold
        self.time_frequency_clustering_threshold_type = \
            args.time_frequency_clustering_threshold_type
        self.time_frequency_clustering_time_padding = \
            args.time_frequency_clustering_time_padding
        self.time_frequency_clustering_frequency_padding = \
            args.time_frequency_clustering_frequency_padding
        self.time_frequency_clustering_skypoints = \
            args.time_frequency_clustering_skypoints
    ...
    def time_frequency_clustering_frequency_padding(self):
        return getattr(self, "_time_frequency_clustering_frequency_padding",
                       None)
    ...
    def estimate_wavelet_psd(self):
        ...
        psd_array = np.array([simulate_psd_from_bilby_psd(

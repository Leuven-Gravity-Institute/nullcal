...
import importlib
from .parser import create_nullcal_parser
...
class MainInput(BilbyMainInput):
    ...
    def analysis_executable(self, analysis_executable):
        if analysis_executable:
            ...
            self._analysis_executable = "nullcal_pipe_analysis"


def create_main_parser():
    _nullcal_pipe_doc = """
    nullcal_pipe is a command line tools for taking user input (as command line
    ...
    """
    return create_nullcal_parser(top_level=True)
